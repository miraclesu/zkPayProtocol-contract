...
async function main() {
	...
	const feeTo = '0x72f29AF7Ab794c63447f0ed8ce2a01D08E6Bb91d'
	const Bob = '0x201615E1a300faB3145d459D3B6405a298f06EA9'
	...
	// const passwordService = await PasswordService.attach('0xC03BaAf74c0b4560645630AaaD213fDc322942Eb')
	...
	// const safeboxFactory = await SafeboxFactory.attach('0xb6692892F247aDE83f1Bf8419940c5c84A3d2786')

	const MockERC20 = await ethers.getContractFactory('MockERC20')
	const usdt = await MockERC20.deploy('MockUSDT', 'USDT')
	await usdt.deployed()
	console.log('usdt deployed:', usdt.address)
	// const usdt = await MockERC20.attach('0x18b43b3F80039F5b68c70c4C31D40156672B37A1')
	...
	console.log('nft.mint done')
	await nft.transferFrom(accounts[0].address, Bob, 2)
